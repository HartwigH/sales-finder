          ...
          <div className="row">
            <div className="col-lg-7 col-md-12 col-sm-12 col-xs-12">
              <div className="contents">
                <h2 className="head-title">Sales finder, Find better deals <br /> & consume smart</h2>
                ...
                <Link className="btn btn-outline-danger" to="/deals/all">Start browsing deals!</Link>
